  ...
  saveRating() {
    this.tasksService.Rating(this.task.id, this.rating).subscribe(() => {
      ...
      if (this.rating < 3) {
        ...
        this.tasksService.sendAlertNotification(this.task.assignedUser.email, this.task).subscribe(() => {
        ...
        this.tasksService.sendSuccessNotification(this.task.assignedUser.email, this.task).subscribe(() => {
